...
for j=1:100  % training trajectories
    % Randomly choose initial condition to generate a tracjectory
    x0=30*(rand(3,1)-0.5);
    [t,y] = ode45(Lorenz,t,x0);
    
    % input is the set of (x,y,z) at time t
    % output is the set of (x,y,z) at time t + dt
    % Thus, the neural net will be trained to move forward 
